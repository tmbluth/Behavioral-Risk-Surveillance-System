...
glm_mi_p <- predict(glm_mi, Test, type = 'prob') 
glm_strk_p <- predict(glm_strk, Test, type = 'prob') 
glm_dep_p <- predict(glm_dep, Test, type = 'prob') 
...
# Predictions
nb_mi_p <- predict(nb_mi, Test, type = 'prob')
prop.table(table(nb_mi_p, Test$CVDINFR4))

nb_strk_p <- predict(nb_strk, Test, type = 'prob')
prop.table(table(nb_mi_p, Test$CVDSTRK3))

nb_dep_p <- predict(nb_dep, Test, type = 'prob')
