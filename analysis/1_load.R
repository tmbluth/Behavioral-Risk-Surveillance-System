...
train_11 <- fread('data/2011.csv', 
   select = c('GENHLTH',  'PHYSHLTH', 'MENTHLTH', 'POORHLTH', 'HLTHPLN1',
              'PERSDOC2', 'MEDCOST',  'CHECKUP1', 'BPHIGH4',  'BPMEDS', 
              'BLOODCHO', 'CHOLCHK',  'TOLDHI2',  'CVDINFR4', 'CVDCRHD4',
              'CVDSTRK3', 'ASTHMA3',  'ASTHNOW',  'CHCSCNCR', 'CHCOCNCR',
              'CHCCOPD',  'HAVARTH3', 'ADDEPEV2', 'CHCKIDNY', 'USENOW3',
              'DIABETE3', 'SMOKE100', 'SMOKDAY2', 'STOPSMK2', 'LASTSMK2',
              ...
              'USEEQUIP', 'AVEDRNK2', 'DRNK3GE5', 'MAXDRNKS', 'PDIABTST',
...
train_12 <- fread('data/2012.csv',
   select = c('GENHLTH',  'PHYSHLTH', 'MENTHLTH', 'POORHLTH', 'HLTHPLN1',
              ...
              'AVEDRNK2', 'DRNK3GE5', 'MAXDRNKS', 'EMTSUPRT', 'LSATISFY',
...
train_13 <- fread('data/2013.csv', 
   select = c('GENHLTH',  'PHYSHLTH', 'MENTHLTH', 'POORHLTH', 'HLTHPLN1',
              ...
              'LASTSMK2', 'USENOW3',  'RREMTSM2', 'AVEDRNK2', 'DRNK3GE5',
              'MAXDRNKS', 'FTJUDA1_', 'FRUTDA1_', 'BEANDAY_',  'GRENDAY_',
...
train_14 <- fread('data/2014.csv',          
   select = c('GENHLTH',  'PHYSHLTH', 'MENTHLTH', 'POORHLTH', 'HLTHPLN1',
              ...
              'SMOKE100', 'SMOKDAY2', 'STOPSMK2', 'LASTSMK2', 'USENOW3',
              'AVEDRNK2', 'DRNK3GE5', 'MAXDRNKS', 'PDIABTST', 'PREDIAB1',
...
test_15 <- fread('data/2015.csv',
  select = c('GENHLTH',  'PHYSHLTH', 'MENTHLTH', 'POORHLTH', 'HLTHPLN1',
             ...
             'STOPSMK2', 'LASTSMK2', 'USENOW3',  'AVEDRNK2', 'DRNK3GE5',
             'MAXDRNKS', 'FTJUDA1_', 'FRUTDA1_',   'BEANDAY_',  'GRENDAY_',
